...
// Sync methods
export const addDeviceTrackingTags = (secretKey, debug) => {
    try {
...
export const addDeviceTrackingTagsCustom = (secretKey, customDomain, trackerName, debug) => {
    try {
...
// Async methods
export const addDeviceTrackingTagsAsync = (secretKey, debug) => {
    if (debug) {
...
export const addDeviceTrackingTagsAsyncCustom = (secretKey, customDomain, trackerName, debug) => {
    if (debug) {
